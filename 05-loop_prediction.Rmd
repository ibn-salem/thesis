...
> Supplementary figures and links to supplementary tables are shown in Appendix \@ref(sup-loop-prediction).
> 
...
<!-- ---------------------------------------------------------------- -->
```{r LoopPred1, fig.cap='(ref:LoopPred1)', out.width='80%', fig.align='center'}
...
<!-- ---------------------------------------------------------------- -->
```{r LoopPred3, fig.cap='(ref:LoopPred3)', out.width='80%', fig.align='center'}
...
<!-- ---------------------------------------------------------------- -->
```{r LoopPred4, fig.cap='(ref:LoopPred4)', out.width='80%', fig.align='center'}
...
(Fig. \@ref(fig:LoopPred1)A) [@Krijger2016; @Naville2015]. For all considered pairs of CTCF motifs *i* and *j*,
we calculated the ChIP-seq profile similarity as Pearson correlation
coefficientof the corresponding coverage vectorsand.
...
scores from the JASPAR motif hit tracks as -log~10~ transformed p-values
[@Khan2018].
...
tool [@Mourad2017]. The package is freely available and easy to install from
GitHub under
[*https://ibn-salem.github.io/sevenC/*](https://ibn-salem.github.io/sevenC/)
and has been submitted to the Bioconductor project [@Rowley2017]. All analysis
