...
def read_references(infile) :
    ...
    #       inRef = True
    #       singleRef = False
    #       print("INFO: Found Reference section!")
    #
    #     if(inRef):
    #       l = line.strip()
    #       if l == "":
    ...
    refPart = content.split("**References**\n", 1)[1]
    ...
    for ref in refs:
      ...
      try:
        ...
        print(ref)
        print("ERROR! could not found it")
...
def replace_refs(content, mapping, separater_str = ",\\ "):
  ...
  def my_repl(match):
    ...
    print(numbers_str)
    numbers = numbers_str.split(separater_str)
    print(numbers)
    numbers = [parse_range(n, separater_str) if "-" in n else n for n in numbers]
    print(numbers)
  ...
  before_intro =  content.split("**Introduction**",1)[0]
  after_intro = content.split("**Introduction**", 1)[1]
...
if __name__ == "__main__":
    ...
    mapping = read_references(args.input_file)
    ...
    content = replace_refs(content, mapping)
