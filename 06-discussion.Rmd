...
This example and other phenotypes caused by TAD disruptions [@Lupianez2015; @Franke2016; @Flottmann2017] show that altered genome folding upon TAD disruption can lead to morphological novelties.
...
## Gene dysregulation by altered TAD structure in disease
...
The causal relationship between TAD disruption, miss-expression and pathogenic phenotypes has been studied recently in more detail (revied for example in [@Krijger2015; @Achinger-Kawecka2017; @Yu2017; @Andrey2017]). 
...
## Integrating genome folding data can explain the pathomechanism non-coding variants

- Out line pipeline and computational integration of publicy availible data
