...
Most duplications appear to be created by tandem duplications in direct orientation [@Newman], which explains the clustering of paralogs in the genome with short genomic distances and often the same transcription senes (Fig. \@ref(fig:paraData)). 
