...
<!-- ## Further directions -->
<!-- - x Many open questions in the field of three-dimensional genome folding. -->
<!-- - x Neo-TADs by tandem-duplication in evolution [@Franke2016] -->
<!-- - x Plasticity and dynamics of chromatin interactions -->
<!-- - x Single-cell resolution  -->
<!--     - x Single cell Hi-C studies: [@Nagano2017; @Stevens2017] -->
<!--     - x Computational modeling of single cells [@Sekelja2016]. -->
<!-- - x Functional mechanism -->
<!--   - x Loop extrusion -->
<!--   - x CTCF and cohesin depletion experiments -->
<!--   - x Establishment of compartments / TADs / loops -->
<!--   - x Independent mechanism for loops and domains on the one hand and compartments on the other hand.  -->
<!--     - x Compartmental segregation was increased on CTCF (or cohesin?) knock out.  -->
<!--     - x Phase-separation model [@DiPierro2017; @Strom2017; @Hnisz2017]. -->
<!--   - x How are loop formation and domain organization regulated? -->
