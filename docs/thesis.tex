...
\addcontentsline{toc}{subsection}{Web Resources}
...
gefaltet. Paarweise Chromatin Interaktionen kommen gebündelt in
diskreten chromosomalen Regionen vor, welche topologically associating
domains (TADs) genannt werden. Ob TADs eine essenzielle Rolle spielen
für die Regulation der Genexpression in der Evolution und in
Krankheiten, wird in dieser Dissertation untersucht. Dazu werden
genomweite Chromatin Interaktions-Karten mit verschiedensten Daten, die
entlang des linearen Genoms erhoben wurden, computergestützt integriert
und analysiert.

Funktional ähnliche Gene gruppieren sich dabei in TADs und teilen sich
regulatorische Elemente im Genom, um eine koordinierte Expression zu
ermöglichen. TADs werden mehrheitlich stabil über die Evolution vererbt
...
werden, um gen-regulatorische Effekte von strukturellen
Chromosomenaberration zu interpretieren, wie hier anhand von Patienten
mit diversen klinischen Phänotypen gezeigt wird. Außerdem wurde eine
Software entwickelt, um anhand von genetischen Sequenzeigenschaften und
Gewebe-spezifischen Signalen von Protein-Bindestellen, genomweite
Chromatin Interaktionen mit hoher Genauigkeit vorherzusagen.

Diese Arbeit zeigt, dass TADs nicht nur strukturelle Einheiten von
...
\item
  ...
  \emph{bioRxiv}. 2017.
  \href{https://doi.org/10.1101/231431}{doi:10.1101/231431}.
\item
  \textbf{Ibn-Salem J\textsuperscript{\#}}, Andrade-Navarro
  MA\textsuperscript{\#}.\\
  \textbf{Computational Chromosome Conformation Capture by Correlation
  of ChIP-seq at CTCF motifs.}\\
  \emph{bioRxiv}. February 2018:257584.
  \href{https://doi.org/10.1101/257584}{doi:10.1101/257584}.
\end{itemize}
...
\begin{itemize}
\item
  \textbf{Imperial College London, MRC London Institute of Medical
  Sciences}, 19 May. 2017, London, UK\\
  Title: \emph{Evolution of TADs and prediction of chromatin looping}
\item
  \textbf{Humboldt University Berlin, Humboldt University Berlin}, 19
  Dez. 2016, Berlin, Germany\\
  Title: \emph{ChIP-seq and related techniques to analyze protein-DNA
  interactions and predict chromatin looping interactions.}
\item
  \textbf{Max-Planck-Institute for Molecular Genetics}, 04 Dez. 2015,
  Berlin, Germany\\
  Title: \emph{Co-regulation of paralog genes in the 3D chromatin
  architecture}
\end{itemize}
...
\begin{itemize}
\item
  \textbf{Basel Computational Biology Conference BC\(^{2}\)}, 12-15 Sept
  2017, Basel, Switzerland\\
  Title: \emph{Prediction of chromatin looping interactions from
  ChIP-seq profiles at CTCF motifs}
\item
  \textbf{ISCB European Student Council Symposium 2016}, 3 Sept 2016,
  The Hauge, Netherlands\\
  Title: \emph{Prediction of Chromatin Looping Events}
\item
  \textbf{ISCB Student Council Symposium 2015}, 10 July 2015, Dublin,
  Ireland\\
  Title: \emph{Co-regulation of human paralog genes in the
...
\begin{itemize}
\item
  \textbf{2017 IMB Conference: Gene Regulation by The Numbers}, 19 - 21
  June 2017, Mainz, Germany\\
  Title: \emph{Prediction of chromatin looping interactions from
  ChIP-seq profiles at CTCF motifs}
\item
  \textbf{15th European Conference on Computational Biology}, 4-7 Sept
  2016, The Hauge, Netherlands\\
  Title: \emph{Co-regulation of paralog genes in the three-dimensional
  chromatin architecture}
\item
  \textbf{German Conference on Bioinformatics 2016}, 12-15 Sept 2016,
  Berlin, Germany\\
  Title: \emph{Prediction of three-dimensional chromatin looping from
  sequence motifs and protein binding signals}
\item
  \textbf{EMBO Conference: From Functional Genomics to Systems Biology},
  12-15 Nov 2016, Heidelberg, Germany\\
  Title: \emph{Three-dimensional chromatin looping predicted by CTCF
  motifs and ChIP-seq signals}
\item
  \textbf{RECOMB Comparative Genomics 2015}, 04-07 Oct.~2015, Frankfurt,
  Germany\\
  Title: \emph{Co-regulation of paralog genes in the three-dimensional
  chromatin architecture}
\item
  \textbf{ISMB/ECCB Conference 2015}, 12-14 July, Dublin, Ireland\\
  Title: \emph{Co-regulation of human paralog genes in the
  three-dimensional chromatin architecture}
\item
  \textbf{Regulatory Genomics Special Interest Group}, 11 July 2015,
  Dublin, Ireland\\
  Title: \emph{Co-regulation of human paralog genes in the
  three-dimensional chromatin architecture}
\item
  ...
  three-dimensional chromatin architecture}
\item
  \textbf{Genome Regulation in 3D Conference}, June 28-30, 2015,
  Rehovot, Israel\\
  Title: \emph{Co-regulation of human paralog genes in the
  three-dimensional chromatin architecture}
\item
  \textbf{German Conference on Bioinformatics 2014}, Sept.~29 - Oct.~1,
  2014, Bielefeld, Germany\\
  Title: \emph{Deletions of chromosomal regulatory boundaries are
  associated with congenital disease}
\item
  \textbf{Annual Meeting of the AGD 2014}, Oct 10-11, Potsdam, Germany\\
  Title: \emph{Deletions of chromosomal regulatory boundaries are
  associated with congenital disease}
\end{itemize}
...
\tightlist
\item
  \textbf{Travel Grant from gsk Stiftung} (350 EUR) for ```Genomic
  Regulation 2018''' workshop, 15-18 March 2018, Nendaz, Switzerland.
\item
  \textbf{Digital Future Scholarship} free admission (900 EUR) to ```The
  Digital Future''' conference on May 13th, 2017 in Berlin
\item
  \textbf{Scientific Event Grant 3,500 Euro} from Boehringer Ingelheim
  Stiftung for Student Symposium on Computational Genomics, Nov 30,
  2016, Mainz
\item
  \textbf{Scientific Meeting Grant 1,500 GBP (\textasciitilde{}1,750
  EUR)} from The Company of Biologists (EA1228) for Student Symposium on
  Computational Genomics, Nov 30, 2016, Mainz
\item
  \textbf{Travel Fellowship Award for 4th ISCB European Student Council
  Symposium 2016}, Sept 2016, The Hauge, Netherlands
\item
  \textbf{Digital Future Scholarship} free admission (900 EUR) to ```The
  Digital Future''' conference on May 11th, 2016 in Berlin
\item
  \textbf{F1000Research Poster Awards from ISMB/ECCB}
\item
  \textbf{Runner-up Poster Presentation Award form ISCB Student Council
  Symposium 2015}
\item
  \textbf{Travel Award to the Genome regulation in 3D meeting}, June
  28-30, Weizmann Institute of Science, Rehovot, Israel
\item
  \textbf{Third poster price of Annual Meeting of the AGD 2014}
\end{itemize}
...
\tightlist
\item
  \textbf{Student Symposium on Computational Genomics, Nov 30, 2016},
  IMB, Mainz, Germany (main organizer and symposium chair)
\end{itemize}
...
\begin{description}
\item[Sep 2014 -- Feb 2018]
\textbf{Research assistant and doctoral student}, \emph{Johannes
Gutenberg University Mainz} and \emph{Institute of Molecular Biology
(IMB)}, Mainz, Germany
\item[May 2017 (for two weeks)]
\textbf{Lab visit}, \emph{Imperial College London}, London, UK. Invited
by Boris Lehnert and Matthias Merkenschlager.\\
Computational analysis of gene expression and 3D genome organization
upon knock-down of cohesin in mouse macrophages and thymocytes
\item[Jun 2014 -- August 2014]
\textbf{Research assistant}, \emph{Computational Biology Group at
Institute for Medical Genetics and Human Genetics}, Charité --
Universitätsmedizin, Berlin, Germany.\\
Computational analysis of structural variations and phenotype
associations.
\item[Sep 2013 -- Jun 2014]
\textbf{Student assistant (Master thesis project)}, \emph{Department
Vingron at Max Planck Institute for Molecular Genetics}, Berlin, Germany
and \emph{Institut de Biologie de l' Ecole Normale Superieure}, Paris,
France\\
Transcription factor binding profiles in ChIP-exo data
\item[Apr 2013 -- Dec 2013]
\textbf{Student assistant}, \emph{Computational Biology Group at
Institute for Medical Genetics and Human Genetics}, Charité --
Universitätsmedizin, Berlin\\
Modeling the effect of genomic deletions of regulatory barriers in the
chromatin structure on gene regulation and phenotypes.
\item[Jan 2011 -- Aug 2013]
\textbf{Student assistant}, \emph{Max Planck Institute for Molecular
Genetics}, Department Lehrarch, Group: Evolution and Development, Berlin
\end{description}
