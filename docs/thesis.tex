...
exposes the \textbf{PITX1} gene to the activation by an enhancer with
specific lower-limb activity \citep{Spielmann2013a}. This example and
other phenotypes caused by TAD disruptions
\citep{Lupianez2015, Franke2016} show that altered genome folding upon
TAD disruption can lead to morphological novelties.
...
While miss-regulation upon TAD disruption might be beneficial for an
organism and allow evolutionary leaps (as discussed above), in most
cases TAD disruptions might be detrimental for an organism, as can be
seen in genetic diseases and cancers (as discussed below).
