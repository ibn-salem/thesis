...
\item
  co-expression
\item
  Co-regulation of paralogs show a functional organization of the
...
\item
  ...
  independent sources. A large fraction of expression can be attributed
  to the positioning of genes in genome architecture and highly
  informative for TAD activity and organization \citep{Rennie2018}.
\item
...
\item
  Discuss paralog co-regulation in context of \citep{Lan2016}.
\item
  However, the creation of paralogs by tandem duplication might also be
  an efficient evolutionary mechanism to introduce additional
  functionality to a gene by keeping the original gene unaffected.
  ...
  \end{itemize}
\item
  Rearrangements of TADs might entangle duplicated genes and enable them
  to be transcribed in a different context.
\item
...
and evolving regulatory context and TADs over time.} Most paralogs are
created by tandem-duplication. Duplication within a TAD allows the new
copy of the gene to be regulated by the same environment (top left).
Over evolutionary time, the interactions pattern and regulatory input
might change to allow for more independent expression regulation (top
center). Evolutionary rearrangements might even relocate the genes to
different chromosomes (top right). Alternatively, the two copies might
stay in the same TAD to enable them to be coordinately regulated
(bottom).}\label{fig:ParalogSeparation}
\end{figure}
...
associated with changes in gene expression programs between the species.
...
\item
  The relation of variant co-transmission in population, in general,
  measured as linkage disequilibrium (LD) correlates with Hi-C
  interaction frequencies \citep{Gerber2018}.
\item
  Follow up studies might experimentally support the functional
  importance of evolutionary conserved TADs.
\item
...
of enhancers were viable but showed strong neurological phenotypes. This
indicates that the remarkably strong sequence conservation likely
results from fitness deficit that appear subtle in a laboratory setting
\citep{Dickel2018}. This effect could be similar for targeted deletions
of conserved TAD boundaries.
...
\hypertarget{clinical-phenotypes-can-be-explained-by-tad-disruptions}{%
\section{Clinical phenotypes can be explained by TAD
disruptions}\label{clinical-phenotypes-can-be-explained-by-tad-disruptions}}
