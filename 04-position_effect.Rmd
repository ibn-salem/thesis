...
# Position effects of rearrangements in disease genomes {#position-effect}

### Preamble {-}
> 
> This chapter was published as a co-first-author paper in the American Journal of Human Genetics:
> 
> Cinthya J. Zepeda-Mendoza^\*^, **Jonas Ibn-Salem^\*^**, Tammy
Kammin, David J. Harris, Debra Rita, Karen W. Gripp,
Jennifer J. MacKenzie, Andrea Gropman, Brett Graham, Ranad
Shaheen, Fowzan S. Alkuraya, Campbell K. Brasington,
Edward J. Spence, Diane Masser-Frye, Lynne M. Bird, Erica
Spiegel, Rebecca L. Sparkes, Zehra Ordulu, Michael E.
Talkowski, Miguel A. Andrade-Navarro, Peter N. Robinson,
Cynthia C. Morton^#^. **_Computational Prediction of Position Effects of Apparently Balanced Human Chromosomal Rearrangements_**. Am J Hum Genet. 2017;101(2):206-217. [doi:10.1016/j.ajhg.2017.06.011](https://doi.org/10.1016/j.ajhg.2017.06.011).
> 
> The publication is availible online: https://doi.org/10.1016/j.ajhg.2017.06.011.
> My contributions to this publication is indicated in Table \@ref(tab:contribution). 
> The source code of the complete analysis is available at GitHub:
> [https://github.com/ibn-salem/position_effect](https://github.com/ibn-salem/position_effect). 
> Supplementary information is shown in Appendix \@ref(sup-position-effect).
>
>
...
and DNA duplications and deletions [@Lejeune1959; @Ford1959; @Jacobs1959; @Stankiewicz2002; @Iafrate2004].

<!-- @Iafrate2004; @Sebat2004; @Conrad2006; @Hinds2006; @Conrad2010]. -->

The discovery of copy-number
...
associations at higher resolution [@Iafrate2004; @Sebat2004; @Hinds2006; @Conrad2006; @Conrad2010; @Korbel2007; @Stankiewicz2010; @Altshuler2010; @Durbin2010; @Carvalho2016].
<!-- @Alkan2009; @Chen2009; @McKernan2009; @Sudmant2010; @International; @HapMap2010] -->
Over the years, analysis of
disease-related structural rearrangements has illuminated genes that are
mutated in various human developmental disorders [@Zhang2009; @Theisen2010; @Nambiar2011; @Higgins2008]. Such chromosome
...
tissues[@Lieberman-Aiden2009; @Fullwood2009; @Dixon2012; @Sanyal2012; @Phillips-Cremins2013; @Rao2014; @Mifsud2015; @Dixon2015] has allowed molecular assessment of the disruption of
...
malformations,[@Lupianez2015] leukemia,[@Groschel2014] and obesity,[@Claussnitzer2015] among others.[@Visser2012; @Roussos2014; @Giorgio2015; @Oldridge2015; @Ibn-Salem2014; @Ordulu2016]
...
subjects from the Developmental Gene Anatomy Project (DGAP)[@Higgins2008; @Ligon2005; @Kim2008; @Lu2007; @Redin2017]
...
large-insert jumping library approach.[@Higgins2008; @Ligon2005; @Kim2008; @Lu2007; @Redin2017; @Talkowski2011] A total of 151 cases
...
for Human Cytogenetic Nomenclature (ISCN2016) (Table \@ref(tab:position-effect-subjects)). Detailed case
...
Table: (\#tab:position-effect-subjects)  **Description of the 17 analyzed DGAP cases with non-coding
...
= DHS enhancer-promoter disrupted interactions).
  ...
  **Subject ID**   **Reported Karyotype**          **Disruption of Functional Elemen**   **Breakpoints within TADs (hESC / IMR90 / GM12878)**   **Top-ranking Candidates ±1 Mb **
  ---------------- ------------------------------- ------------------------------------- ----------------------------------------------------   -----------------------------------
...
generated by DGAP,[@Higgins2008; @Ligon2005; @Kim2008; @Lu2007; @Redin2017] the largest collection of sequenced
...
inversions (Figure \@ref(fig:position-effect-1) and [Table S](#position-effect-sub-tab)1). These subjects are phenotypically
...
<!-- ======================================================= -->
```{r position-effect-1, fig.cap='(ref:position-effect-1)', out.width='80%', fig.align='center'}
knitr::include_graphics("figures/position_effect/Figure1.png")
```
(ref:position-effect-1) **Chromosome locations of the 17 analyzed DGAP cases with non-coding BCAs.** Breakpoint positions are marked with a blue line and
...
(TF) binding sites (GAT TF p=0.0003, promoter p=0.0001, [Table S](#position-effect-sub-tab)2,3).
Only one breakpoint (DGAP249\_B) overlapped a ChromHMM enhancer in
GM12878 cells (Table \@ref(tab:position-effect-subjects)); the others had no overlap with annotated or
...
al*., 2014[@Andersson2014] ([Table S](#position-effect-sub-tab)4). Eight breakpoints overlapped cell-type
specific DHS sites (Table \@ref(tab:position-effect-subjects) and [Table S](#position-effect-sub-tab)5); these corresponded to DGAP
...
176, and 287) and none in GM12878 cells (Table \@ref(tab:position-effect-subjects) and [Table S](#position-effect-sub-tab)6). Except
...
(GAT p= 0.40 for GM12878 and p= 0.15 for H1-hESC, [Table S](#position-effect-sub-tab)2F).
Interestingly, 22 of the 34 breakpoints (\~65%) overlap repeated
elements at a significant level (GAT p=0.0002, [Table S](#position-effect-sub-tab)8), which may
...
lines (Table \@ref(tab:position-effect-subjects) and [Table S](#position-effect-sub-tab)9).[@Dixon2012] However, this overlap was not
...
contacts at 100 Kb and 1 Mb resolution in GM06990 cells ([Table S](#position-effect-sub-tab)11).
...
[Table S](#position-effect-sub-tab)11). With the availability of higher resolution data, it is
...
34 breakpoints are contained within GM12878 sub-compartments (Table \@ref(tab:position-effect-subjects)
and [Table S](#position-effect-sub-tab)10); interestingly, 28 of these are classified as members of
...
([Table S](#position-effect-sub-tab)10), which are regions of enhanced contact frequency that tile
...
interactions in the GM12878 Hi-C data ([Table S](#position-effect-sub-tab)12).
...
phenotype ([Table S](#position-effect-sub-tab)15).
...
to HPO terms ([Table S](#position-effect-sub-tab)16), and calculated phenotype similarity between
...
±3 and ±1 Mb windows, as well as within the TAD positions ([Table S](#position-effect-sub-tab)15).
...
([Table S](#position-effect-sub-tab)13). A total of 133 candidate genes were separated from &lt;10
of their predicted enhancers, while 60 genes were separated from their
predicted interactions with 10 or up to 91 enhancers ([Table S](#position-effect-sub-tab)14).
...
for the 17 analyzed DGAP cases within ±1 Mb analysis windows (Table \@ref(tab:position-effect-subjects)
and [Table S](#position-effect-sub-tab)15). This is a significant reduction compared to the initial
...
ClinGen ([Table S](#position-effect-sub-tab)15).
...
(Figure \@ref(fig:position-effect-2)).Expression assessment for second-tier candidates *PAK3*,
*MID2* and *POU3F4* in DGAP176 LCLs did not deviate substantially from
their control expression values (Figure \@ref(fig:position-effect-S1)); further searches into the
...
<!-- ======================================================= -->
```{r position-effect-2, fig.cap='(ref:position-effect-2)', out.width='50%', fig.align='center'}
knitr::include_graphics("figures/position_effect/Figure2.png")
```
(ref:position-effect-2) **Assessment of gene expression changes for DGAP163-derived LCLs.** 
Each column represents the ΔCT results of three culture
...
breakpoints ([Table S](#position-effect-sub-tab)19). Of these, 489 had rearrangements that
overlapped one or more annotated genes ([Table S](#position-effect-sub-tab)20). Only five DECIPHER
cases fulfilled our non-coding selection criteria ([Table S](#position-effect-sub-tab)21): cases
...
breakpoints ([Table S](#position-effect-sub-tab)22). Of these, only five variants had associated
...
chromatin environment leading to disease;[@Lupianez2015; @Groschel2014; @Visser2012; @Roussos2014; @Giorgio2015; @Ibn-Salem2014] these
...
subjects’ clinical phenotypes (Table \@ref(tab:position-effect-subjects)).
...
resolution ([Table S](#position-effect-sub-tab)18). For example, the DGAP275\_B breakpoint is
...
BCAs ([Table S](#position-effect-sub-tab)14). For example, *SOS1*, one of the most significant
...
88 predicted enhancers (Figure \@ref(fig:position-effect-3)), and exhibited a decrease in
...
<!-- ======================================================= -->
```{r position-effect-3, fig.cap='(ref:position-effect-3)', out.width='50%', fig.align='center'}
knitr::include_graphics("figures/position_effect/Figure3.png")
```
(ref:position-effect-3) **Disrupted enhancer-promoter DHS interactions predicted for *SOS1* ** 
(gene position indicated by asterisk). The color graded rectangle
