...
and is reviewd comprehensively by leading expertes in the field [@Pombo2015; @Sexton2015; @Bouwman2015; @Dekker2016; @Dixon2016; @Schmitt2016; @Bonev2016; @Hnisz2016; @Merkenschlager2016; @Long2016; @Ruiz-Velasco2017; @Andrey2017].
...
Importantly, enhancer-promoter interactions seems to be mostly constrained within TADs [@Shen2012; @Ghavi-helm2014; @Symmons2014]
...
leads to the question whether disrutpion of TADs could also be and mechansim of disease pathology. This hypothesis were initilay dirven by studying the etiology of the Liebernberg syndrome, in which an upper-limb malformation phenotype is casued by deletion in the vinicity of *PITX1* gene. *PITX1* becomes therby accessible to an enhancer with specific activity in lower-limb and was missexpressed in a corresponding mouse model [@Spielmann2012]. 
An overlap of thes deletion with later identifed TAD boundaries lead to the hypothesis of an regulatory effect mechanism of boundary deletions referred to as enhancer adoption [@Spielmann2013a].

An association of TAD disrutpions with disease was first shown by computational analysis integrating TAD structures, with tissue specific enhancers, and large crhomosomal deletions associated with clinical phenotypes [@Ibn-Salem2014].

In this study, the Human Phenotype Ontology database [@Kohler2014] was used to relate the phenotypes of 922 deletion cases from the DECIPHER database [@Firth2009] to monogenic diseases associated with genes in or adjacent to the deletions. This was used to differntiate for each deletion case between two possible pathogenic effect mechanism that best explains the phenotypes observed in the patients. Many deletions could be explained by a gene dosage mechansim and haploinsufficiency of genes located within the deletion. 
However, about 12 percent of cases could be best explained by a TAD boundary disruption and a specific combinations of tissue-specific enhancers and genes in adjacent TADs. 
Importantly, randomization of phenotype data showed that this enhancer adaption mechanism was significantly more frequent then expected by chance [@Ibn-Salem2014].
Therfore, this study shows for the first time an association of TAD disrutpiton with genetic diseases and highglight an regulatory effect mechansims of TAD disruption that need to be further investigated and has to be considered when interpreting the gentic variations in patient genomes.
