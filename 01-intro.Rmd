...
into two compartments mayor clusters, rerferred to as A/B-compartments [@Lieberman-Aiden2009].
...
These engage in dynamic long-range chromatin loops, some of which are stabilized by architectural proteins, such as CTCF and cohesin, and lead to the fromation of TADs.
