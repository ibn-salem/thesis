...
- How are duplicated genes during evolution distributed in the three-dimensonal gneome architecture? 
- Can TADs provide regulatory envirnoment for co-regulation of duplicated genes?
...
- Are TADs conserved during evolution or disrupted by rearragements?
...
- Are ther signals form TF ChIP-seq data at chromtin looping anchors that predict long-range contacts?
- Does the gnomic sequnce encode features that are predicive for chromatin looping interacionts?
- Can we provide a computational method to predict chromatin looping interactions in specifc cell-types and conditions of interest?
