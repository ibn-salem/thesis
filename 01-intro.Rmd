...
and is reviewd comprehensively by leading expertes in the field [@Pombo2015; @Sexton2015; @Bouwman2015; @Dekker2016; @Dixon2016; @Schmitt2016; @Bonev2016; @Hnisz2016a; @Merkenschlager2016; @Long2016; @Ruiz-Velasco2017; @Andrey2017].
...
Furthermroe, TADs correspond to regions of early and late replication timing [@Pope2014; @Dileep2015] and lamina associated domains (LADs) [@Dixon2012].
Importantly, enhancer-promoter interactions seems to be mostly constrained within TADs [@Shen2012; @Ghavi-helm2014; @Symmons2014] and initial studies report slightly increased co-expression of genes within the same TAD [@Nora2012].
...
To function as a transcriptional regulator,  an enhancer is brought into close spatial proximity with its target promoter through chromatin looping.
...
In two studies depletion of cohesin reduced interactions within TADs but did not alter TAD strucures completley [@Seitan2013; @Zuin2014]. One study report a significant increase in interactions between differnt TADs after cohesin depletion [@Sofueva2013]. Depletio of CTCF had a similar effect with increased inter-domains interactions [@Seitan2013; @Zuin2014].
These result suggest a functinoal role of cohesin and CTCF in promoter-enhancer interactions and TAD formation [@Pombo2015].
...
An overlap of this deletion with later identified TAD boundaries leads to the hypothesis of a regulatory effect mechanism of boundary deletions referred to as enhancer adoption [@Spielmann2013a].
...
To analyze such a position effect, careful integration of diverse genomic and phenotypic data is needed. Computationally tools could predict the effect of rearrangement breakpoints on TAD disruption and potential regulatory effects on phenotypically relevant genes. This would improve molecular diagnoses of many patients with variants of unknown significance.
