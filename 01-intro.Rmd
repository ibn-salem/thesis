...
For their ability to function as transcriptional regulators, enhancers need to be brought into close spatial proximity with its target promoter. 
...
In vertebrates, only a some of these proteins are conserved, indicating a partially different set of factors with such functions [@Phillips-Cremins2013; @Bonev2016]. 
