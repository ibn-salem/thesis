...
# Supporting Information: Co-regulation of paralog genes in the three-dimensional chromatin architecture {#sup-paralog-regulation}
...
# Supplementary Data: Evolutionary stability of topologically associating domains is associated with conserved gene regulation {#sup-TAD-evolution}
...
```
(ref:position-effect-S1)  **Assessment of gene expression changes for DGAP176-derived LCLs.** 
Control gene expression is shown in blue and surveyed genes are
marked in different colors. Each column represents the ΔCT results of
...
standard deviation calculated from the biological replicates per gene.
<!-- ----------------------------------------------------------------------- -->
