...
\subsection{Charmatin dynamics across cell
types}\label{charmatin-dynamics-across-cell-types}
...
\addcontentsline{toc}{subsection}{Is the three-dimensional folding of
...
\addcontentsline{toc}{subsection}{Are TADs functional building blocks of
genomes and subjected to selective pressure during evolution?}
...
The following four chapters dress and discuss these questions. First, we
...
whole-genome alignment between human and other vertebrate genomes to
...
and currently under review. A preprint is published at bioRxiv:
...
\citep{Iafrate2004, Sebat2004, Hinds2006, Conrad2006, Conrad2010, Korbel2007, Stankiewicz2010, Altshuler2010, Durbin2010, Carvalho2016}.
...
\chapter{TAD evolution: Supporting Information}\label{sup-tad-evolution}
...
\hypertarget{position-effect-sub-tab}{\section{Supplemental Table
Legends}\label{position-effect-sub-tab}}
...
\toprule
Contributor Role & Role Definition & Paralog regulation (Chapter \textbackslash{}@ref(paralog-regulation)) & TAD evolution (Chapter \textbackslash{}@ref(TAD-evolution)) & Position effect (Chapter \textbackslash{}@ref(position-effect)) & Loop prediction (Chapter \textbackslash{}@ref(loop-prediction))\\
\midrule
